...
@section('title', 'Add content services')
    ...
    <div class="col-md-12">
        ...
        <div class="mask rgba-white-slight card mb-4">
            ...
            <div class="h6 card-header text-left">
                <span id="card_title" style="color: #0b5570; font-size: 18px;"> Add Service </span><br>
            </div>
            <!--Card header end-->
            <form method="POST" action="{{ route('service.save') }}" enctype="multipart/form-data">
                ...
                <div class="panel">
                    ...
                    <div class="panel-heading">
                        ...
                        <li class="nav-item"><a class="nav-link active"><span class="fa fa-upload mr-2"></span>Add Subscribable Product</a></li>
                    </ul>     
                    </div>
                    <!-- Nav tabs end -->
